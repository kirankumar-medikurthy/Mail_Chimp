      ...
      <div className="middleboxes">
        ...
        <div>
          ...
          <div className="inputtypelayouts">
            ...
            <div>
              <label className="businessname" for="businessname">
                Business Name
              </label>
              <br />
              <input
                className="businessname_inputbox"
                type="text"
                placeholder="Enter your Bussiness Name"
              />
            </div>
            <div>
              <label className="companyname" for="companyname">
                Company Name
              </label>
              <br />
              <input
                className="companyname_inputbox"
                type="text"
                placeholder="Enter the Company Name"
              />
            </div>
            <div>
              <label className="phonenumber" for="phonenumber">
                Phone Number
              </label>
              <br />
              <input
                className="phonenumber_inputbox"
                type="text"
