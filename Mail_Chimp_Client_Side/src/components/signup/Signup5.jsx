    ...
    return (<div id="singup4layout">
        ...
        <div className="middleboxes">
            ...
            <div>
                ...
                <div className="includepeoples">This can include people who signed up to receive marketing emails
from your organization, or those who solely receive transactional
emails. Learn more about <span className="contacttypecolor">Mailchimp contact types</span>.</div>
