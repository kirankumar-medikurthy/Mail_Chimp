  ...
  return (
    <div id="singup4layout">
      ...
      <div className="middleboxes">
        ...
        <div className="selectionbar">
          <div className="selection">
            Selection <span className="greaterthan">{">"}</span>{" "}
          </div>
          <div className="payment">
            Payment <span className="greaterthan">{">"}</span>
          </div>
          <div className="conformation">Confirmation</div>
        </div>
        <div className="boxes">
          <div className="box1-kk">
          ...
          <div>
            <div className="purchasesummarylayout">
              ...
              <div className="buildindian">
                Billed in{" "}
                <span className="buildindianrupees">Indian Rupee</span>
              </div>
            </div>
      ...
      <div className="flowerlayout">
        <img
          className="flowerimagelayout"
          src="/project_images/signup_images/flowerimage.png"
          alt="flowerimage.png"
        />
      </div>
    </div>
