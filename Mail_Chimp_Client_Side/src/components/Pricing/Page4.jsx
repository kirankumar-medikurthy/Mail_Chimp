      ...
      <div id="navbar">
        ...
        <div className="premiumboxes">
          <div className="prembox1">
            ...
            <div className="rs">
              Rs <h1 style={{ display: "inline" }}>23,000</h1>
            </div>
            ...
            <div className="tickboxes">
              <div className="insideTextpremium">
                <img
                  src="/project_images/page4_images/tick.svg"
                  alt="tick.svg"
                />
          ...
          <div className="prembox2">
            ...
            <p className="datadriven">
              Data-driven automation and optimization faster.
            </p>
            <p className="startsat">Starts at</p>
            <div className="rs">
              Rs <h1 style={{ display: "inline" }}>1,150</h1>
            </div>
            <p className="monthlycontact">/month based on 10,000 contacts*</p>
            <p className="contact">How many contacts do you have?</p>
            <button className="btn">Buy Now</button>
          ...
          <div className="prembox4">
            ...
            <p className="AllMultiple">
              All the multi-channel tools you need to audience.
            </p>
            <p className="startsat">Starts at</p>
            <div className="rs">
              Rs <h1 style={{ display: "inline" }}>0</h1>
            </div>
            <p className="monthlycontact">/month based on 10,000 contacts*</p>
            <p className="contact">How many contacts do you have?</p>
            <Link to="/signup">
        ...
        <div className="calculatepricebox">
          <div className="selectplan">
            ...
            <div className="contactContext">
              Plan pricing starts at 500 contacts, Select your audience size to
            ...
            <div className="contactline">
              ...
              <img
                className="sliderimg"
                src="/project_images/page4_images/slider.png"
                alt="slider.png"
              />
          ...
          <div className="mail_chiprecommendationlayout">
            ...
            <div className="monthlyemailcontent">
              *To see the monthly emails send limit included with your specific
              plan, click Calculate my price. If your plan’s contact or email
              send limit is exceeded, you will be charged for overages (except
              for Free plan, where sending will be paused until the next monthly
              plan cycle).
            </div>
          </div>
        </div>
        <div className="actualprice">
          *Actual price may vary. Prices displayed exclude VAT, which will be
          added to the cost of all services purchased. If you select USD, the
          price displayed are estimates based on the INR-USD exchange rate.
          Exact amounts charged for payments made in USD will vary based on the
          exchange rate at the time of payment processing. For exact base
          pricing, please refer to prices listed in INR.
        </div>
        <div className="FeaturedproductsLayout">
          <div className="featureproductitle">Featured Product :</div>
          <div className="unlimitedoneone">
            Create unlimited one-on-one and group services with our new{" "}
            <span className="advancedscheduled">
              Advnced <br />
              Scheduling
            </span>{" "}
            add-on for $8/month.
        ...
        <div>
          <div className="businessOnlineImagelayout1">
            <img
              className="businessOnlineImage"
              src="/project_images/page4_images/business_online.png"
              alt="Business Online.png"
            ></img>
            <div>
              <div className="freetools">
                Also include: Free tools for getting your business online
              </div>
              <div className="businessOnlineMarketing">
                All Marketing plans come with Free website commerce fea-tures,
                so you can build your dream online presence. But if youwant more
              ...
              <button className="seewebsite">
                See Website & Commerce plans
              </button>
            </div>
          </div>
          <div className="businessOnlineImagelayout2">
            <img
              className="prefer_to_pay"
              src="/project_images/page4_images/prefer_to_pay.png"
              alt="prefer_to_pay.png"
            ></img>
            <div>
              <div className="prefer_to_pay_you">Prefer to pay as you go?</div>
              <div className="insteadofpaying">
                Instead of paying a monthly recurring charge, you can buy email
                credits as needed through our PayAs You Go plan.It’s best for
                infrequent senders.
              </div>
          ...
          <div className="businessOnlineImagelayout3">
            <img
              className="businessOnlineImage"
              src="/project_images/page4_images/client.png"
              alt="client.png"
            ></img>
            <div>
              <div className="freetools">
              ...
              <div className="businessOnlineMarketing">
                Unlock the tools you need to get work done for clients when you
                sign up through Mailchimp & Co. our community for freelancers
                and agencies. It’s free to join with any Mailchimp plan.
              </div>
          ...
          <div className="twofactorauthentication">
            <div>
              ...
              <div className="twofactorcontent">
                ...
                your Mailchimp account with an app like Google Authentication or
            ...
            <div>
              <div className="ratefornonprofits">
                Rates for nonprofits and charities
              </div>
              <div className="ratefornonprofitscontent">
                Mailchimp offers a 15% discount to nonprofits and charitie. To
                request the discount, sign up for a free account, and contact
                our Billing team with your username and a link to your
        ...
        <div className="sendinglimit">
          What happens if I hit my contact or sending limit?
        </div>
        <div>
          <div className="FAQs">FAQs</div>
          <div className="tablecontent">
            <div className="paymentmethodoffer">
              What payment methods do you offer?{" "}
              <span>
                <img
                  style={plusStyle}
                  src="/project_images/page4_images/pluscircle.png"
                  alt="pluscircle.png"
                />
              </span>
            </div>
            <div className="paymentmethodoffer1">
            ...
            <div className="paymentmethodoffer2">
              Can I buy credit instead?
              <span>
                <img
                  style={plusStyle}
                  src="/project_images/page4_images/pluscircle.png"
            ...
            <div className="paymentmethodoffer3">
            ...
            <div className="paymentmethodoffer4">
              What happens if I hit my contact or sending limit?
              <span>
                <img
                  style={plusStyle}
        ...
        <div className="footerimages">
          <img
            className="eastfork"
            src="/project_images/page4_images/eastfork.png"
            alt="eastfork.png"
          />
          <img
            className="cronicalimage"
            src="/project_images/page4_images/cronicalimage.png"
            alt="cronicalimage.png"
          />
          <img
            className="fader"
            src="/project_images/page4_images/fader.png"
            alt="fader.png"
          />
          <img
            className="sweat"
            src="/project_images/page4_images/sweat.png"
            alt="sweat.png"
          />
        </div>
      </div>
