        ...
        <>
            <div className="cont10">
                <div className="cont101">
                        ...
                        <div className="cont103">
                            <div className="cont104">
                                <div className="cont105">
                                    <img className="pencil" src={require('../../../public/project_images/landingpage_images/pencil.svg').default} alt="" />
                                    <img className="line" src={require('../../../public/project_images/landingpage_images/line.svg').default} alt="" />
                                </div>
                    ...
                    <img className="que" src={require('../../../public/project_images/landingpage_images/ques.svg').default} alt="" />
                </div>
            </div>
        </>
    )
