        ...
        <>
            <div>
                ...
                <div className='cont1'>
                    <div className='cont13'>
                        <div className='cont14'>
                            ...
                            <div className='para'>With Mailchimp, you get the tools you need to
                                sell your product, reach new cutomers, and
                                take your busines to the next level.</div>
                ...
                <div className='cont2'>
                    ...
                    <div className='p1'>We’re build for growing business. Put our marketing and ale tools
                        behind your idea, dream, brand, or business and we’ll help you share it
                        with the world.
                    </div>
                    <div className='box1'>
                        <div className='box11'>
                ...
                <div className='cont3'>
                    ...
                    <div className='para3'>No matter the size of your business, our tools are here to help you
                    ...
                    <div className='cont32'>
                        <div className='cont321'>
                            ...
                            <div className='para313'>Build a beautiful website with a custom domain, launch
                                an online store, and allow customers to book
                    ...
                    <div className='cont31'>
                        ...
                        <div className='cont311'>
                            ...
                            <div className='para313'>Add a personal touch without the personal effort
                                through automated messages that reach your customers at exactly the
                                rigjht moments.
                            </div>
                        </div>
                    </div>
                    <div className='cont33'>
                        <div className='cont331'>
                            ...
                            <div className='im432'>Put your people at the heart of your
                                ...
                                know your audience and insights that
                                can help drive better results.
                            </div>
                        </div>
                        <div className='cont331'>
                            ...
                            <div className='im432'>Let your brand shine through with easy-
                                ...
                                and AI- powered customs designs.
                            </div>
                        </div>
                        <div className='cont331'>
                            ...
                            <div className='im432'>With all your data and insights in one
                                ...
                                and get recommendations to help you
                                do more of it.
                            </div>
                        </div>
                    </div>
                    <div className='head32'>Ready to get started?</div>
                    <div className='b3'><Button name='Sign Up'/></div>
                </div>
                ...
                <div className='cont5'>
                    ...
                    <div className='b4'><Button name='Sign Up'/></div>
                </div>
