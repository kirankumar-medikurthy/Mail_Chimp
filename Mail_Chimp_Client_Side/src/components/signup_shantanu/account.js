...
function Account() {
  return (
    <div className="abox">
      <div className="sideyrec"></div>
      <div className="mainsbox">
        <div className="navnote">
          <h2 className="accountset">Account Set Up</h2>
          <h2 className="rot">
            plan {">"} profile {">"}
            <span className="adresapan"> Adress </span>
            {">"} contact {">"} costamize {">"} finish
          </h2>
        ...
        <div className="formdatadiv">
          <div>
            ...
            <p className="formdis">
              But why? Believe it or not, we need a physical address to make
              sure your emails comply with international anti-spam laws. Don’t
              have an official business address? Learn about physical address
              alternatives
            </p>
          </div>
          <div>
            <h3 className="inpttext">
      ...
      <div className="yrect">
        <img
          className="sidepic3"
          src="/project_images/shantanu_pics/sidepic.png"
          alt=""
        />
      </div>
    </div>
